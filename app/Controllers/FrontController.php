<?php
	...
	class FrontController
	{
		...
		public function handleRequest()
		{
			...
			{
				list( 'estimated-car-value' => $carValue, 'tax-percentage' => $taxPercentage, 'nb-of-instalments' => $nbOfInstalments, 'time-offset' => $utcTimeOffset ) = $_POST;
				$policyCalculator  = new PolicyCalculator( (int) $carValue, (int) $taxPercentage, (int) $nbOfInstalments, $utcTimeOffset );
				$policyInstalments = $policyCalculator->getInstalments();
				$data              = [];
				$policyData        = [
